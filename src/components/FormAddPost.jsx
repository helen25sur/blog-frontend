      ...
      <div className="form-container max-w-220 mb-15">
        <form className="font-[Inter] text-2xl mb-10 flex flex-col ">
          <div className="form-group mb-4 flex flex-col gap-2">
            ...
            <input className="py-3 px-4 text-base font-[inherit] text-[#101828] bg-white border border-[#D0D5DD] rounded-lg focus:outline-none focus:border focus:border-[#4C1D95] focus:ring-4 focus:ring-[#4C1D951a]" value={title} id="title" name="title" onChange={e => setTitle(e.target.value)} placeholder="Enter Post Title" required />
          </div>
          <div className="form-group mb-4 flex flex-col gap-2">
            <label className="text-sm text-[#344054] font-semibold" htmlFor="imageURL">Image URL</label>
            <input className="py-3 px-4 text-base font-[inherit] text-[#101828] bg-white border border-[#D0D5DD] rounded-lg focus:outline-none focus:border focus:border-[#4C1D95] focus:ring-4 focus:ring-[#4C1D951a]" value={imageURL} id="imageURL" name="imageURL" onChange={e => setImageURL(e.target.value)} placeholder="Image URL" required />
          ...
          <div className="form-group mb-4 flex flex-col gap-2">
            ...
            <textarea className="min-h-45 py-3 px-4 text-base font-[inherit] text-[#101828] bg-white border border-[#D0D5DD] rounded-lg focus:outline-none focus:border focus:border-[#4C1D95] focus:ring-4 focus:ring-[#4C1D951a]" name="content" value={content} onChange={e => setContent(e.target.value)} placeholder="Write your post content here... Markdown is supported." required />
          </div>
